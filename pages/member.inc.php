...
use SLiMSOAuth\OAuthFactory;
use SLiMSOAuth\Provider\Google;
...
OAuthFactory::use($config['class']??Google::class);

if (isset($_GET['code']))
{
    OAuthFactory::auth(function($factory){
...
// OAuth Url
$SLiMSOAuthUrl = OAuthFactory::getAuthUrl();
?>
    <div>
        ...
        if (!empty($OAuthError = OAuthFactory::getError()))
        {
            echo '<div class="errorBox alert alert-danger">' . $OAuthError . '</div>';
        }
        ?>
